...
<<<<<<< HEAD
// impl<'a, 'b, T: plotters::drawing::backend::DrawingBackend, B: plotters::coord::CoordTranslate> Plot<'a, 'b, T, B> {
//     pub fn new() -> Plot<'a, 'b, T, B> {
//         Plot {root: BitMapBackend::new("kym.png", (1024, 768)).into_drawing_area(),
//               data: vec![],
//               chart: None}
//     }
// }
